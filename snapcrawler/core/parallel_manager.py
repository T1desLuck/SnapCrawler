...
class ParallelManager:
    ...
    def __init__(self, config_path: str):
        ...
        self.image_queue = multiprocessing.Queue(maxsize=1000)  # Изображения от обхода к фильтрации
    ...
    def shutdown(self):
        ...
        if self.crawling_process and self.crawling_process.is_alive():
            ...
            self.crawling_process.join(timeout=10)
        ...
        if self.filtering_process and self.filtering_process.is_alive():
            ...
            self.filtering_process.join(timeout=10)
