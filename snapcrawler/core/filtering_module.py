...
class FilteringModule:
    ...
    def apply_filters(self, image_path: str) -> bool:
        ...
        try:
            ...
            if self.filtering_config.get('enable_deduplication', True):
            ...
            if (self.filtering_config.get('detect_watermarks', False) and 
                not self.filtering_config.get('allow_watermarks', True)):
